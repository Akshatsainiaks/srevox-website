...
<img src="https://raw.githubusercontent.com/Akshatsainiaks/srevox-website/main/public/favicon.svg" width="80" height="80" alt="Srevox"/>
...
timeline
    ...
    v1.0.0 [Core Release] : Core crash detection
                         : Multi-channel alerts
                         : AI diagnosis (Groq/OpenAI/Anthropic/Ollama)
                         : Docker-native deployment
    v1.1.0 [Stable Release] : Team management & role assignments
                            : Secure user invitation flows
                            : Service owner routing paths
                            : Multi-tenant email isolation
    v1.2.0 [Pro Tier] : Audit logs
                      : Unlimited clusters & channels
    v2.0.0 [Enterprise] : Enterprise SSO / SAML
                        : Custom dashboards
